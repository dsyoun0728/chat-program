...
public class SystemInputParser {
    ...
    public SystemInputParser(slowClient slowClient, Scanner scanner) {
        this.slowClient = slowClient;
        this.scanner = scanner;
        this.writer = new Writer(this.slowClient);
    }
    ...
    public void startClient() throws IOException {
        ...
        this.slowClient.startClient(this.writer, firstInput);
